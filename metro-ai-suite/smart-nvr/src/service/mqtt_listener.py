...
def on_message(client, userdata, msg):
    ...
    try:
        ...
        if label and camera_name and start_time and end_time and (end_time - start_time) >= 3:
            ...
            logger.warning("⚠️ Skipping event due to missing required fields or short duration (< 3s).")
